 ...
 * @author Raheez
 */
public class employeevehicles extends javax.swing.JFrame {
    ...
    /**
     * Creates new form employeevehicles
     */
    public employeevehicles() {
        initComponents();
    }
    
     public employeevehicles(String uname) {
         EID = uname;
        initComponents();
     ...
     public void loadData(){
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String sql2 = "select model,type,price,lotno from vehicles where vid='"+rs.getString("vid")+"'";
                ...
                while(rs2.next()){
                    ...
                    columnData[4] = rs2.getString("lotno");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Vehicles under Employee");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(employeevehicles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new employeevehicles().setVisible(true);
            }
        });
    }
