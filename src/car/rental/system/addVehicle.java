...
public class addVehicle extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 350, 265, 39));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String Lot = jTextField6.getText();
        
        
        connection = Connector.ConnectDb();
        
        String sql = "insert into vehicles(vid,model,type,price,sid,lotno) values (?,?,?,?,?,?)";
