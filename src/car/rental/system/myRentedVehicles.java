 ...
 * @author Raheez
 */
public class myRentedVehicles extends javax.swing.JFrame {
    String CID;
    ...
    /**
     * Creates new form myRentedVehicles
     */
    public myRentedVehicles() {
        initComponents();
    }
    
    public myRentedVehicles(String uname) {
        CID = uname;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("My Rented Vehicles");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(myRentedVehicles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new myRentedVehicles().setVisible(true);
            }
        });
    }
