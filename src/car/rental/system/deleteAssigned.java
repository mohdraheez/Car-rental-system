 ...
 * @author Raheez
 */
public class deleteAssigned extends javax.swing.JFrame {
    String SID;
    ...
    ResultSet rs3 = null;
    /**
     * Creates new form deleteAssigned
     */
    public deleteAssigned() {
        initComponents();
    }
    
     public deleteAssigned(String uname) {
        SID = uname;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Delete Assigned Vehicles");
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 40, 170, -1));
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 40, 90, 40));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 40, 170, -1));
        ...
        jPanel1.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 40, 90, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "delete from manages where eid = '" + uid+"' and vid ='"+vid+"'";
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
            ...
            JOptionPane.showMessageDialog(null, "Employee not found "+e);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deleteAssigned.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new deleteAssigned().setVisible(true);
            }
        });
    }
