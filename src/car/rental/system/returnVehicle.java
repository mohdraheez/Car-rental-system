...
public class returnVehicle extends javax.swing.JFrame {
     ...
     */
    public returnVehicle(String uname) {
        CID = uname;
        initComponents();
        Object columns[] = {"Vehicle ID", "Model", "type"};
    ...
    public void loadData(){
        ...
        String sql = "select vid from rentedto where cid='"+CID+"'";
        ...
        try {
            ...
            while (rs.next()) {
                String sql2="select model,type from vehicles where vid='"+rs.getString("vid")+"'";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Return Vehicles");
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 40, 170, -1));
        ...
        jLabel3.setText("My Rented Vehicles");
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 52, 150, 30));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 40, 140, 40));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       String sql="update rentedto set cid="+null+",issuedate="+null+",duedate="+null+" where cid='"+CID+"'";
       ...
       try{
           ...
           JOptionPane.showMessageDialog(null,"Returned Vehicle");
       }
       catch(SQLException e){
           JOptionPane.showMessageDialog(null,e);
