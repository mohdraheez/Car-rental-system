 ...
 * @author Raheez
 */
public class rentalLogin extends javax.swing.JFrame {
    PreparedStatement prp = null;
    ResultSet result = null;
    Connection connection = null;
    /**
     * Creates new form rentalLogin
     */
    public rentalLogin() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String sql ="select password from rentalshop where sid ='"+user+"'";
        ...
        try{
            ...
            if(pass.equals(result.getString("password"))){
                ...
                shopActivity shop = new shopActivity(user);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rentalLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rentalLogin().setVisible(true);
            }
        });
    }
