...
public class deleteEmployee extends javax.swing.JFrame {
    ...
    public deleteEmployee(String user) {
        ...
        Object columns[] = {"Employee ID", "Name", "Address","Phone"};
    ...
    public void loadData(){
        ...
        String sql = "select eid,name,address,phone from employees where sid='"+SID+"'";
        try {
            ps = connection.prepareStatement(sql);
            rs = ps.executeQuery();
            Object columnData[] = new Object[6];
            while (rs.next()) {
                columnData[0] = rs.getString("eid");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 40, 170, -1));
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 40, 160, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "delete from employees where eid = '" + uid+"' and sid ='"+SID+"'";
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
            
            JOptionPane.showMessageDialog(null, "Employeed" + uid + " has been deleted");
